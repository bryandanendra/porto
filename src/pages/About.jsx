  ...
  return (
    <section id="about" className="py-8 px-4 sm:px-8 max-w-[1400px] mx-auto overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-white mb-16 max-w-4xl mx-auto justify-items-center">
        <SpotlightCard spotlightColor="rgba(52, 211, 153, 0.3)" className="w-full max-w-md flex flex-col h-full">
          ...
          <div className="flex justify-start">
            <a 
              href="#contact" 
              className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-emerald-900/50 hover:bg-emerald-800/60 text-emerald-400 rounded-full border border-emerald-500/40 transition-colors duration-300 w-fit"
            >
        ...
        <SpotlightCard spotlightColor="rgba(139, 92, 246, 0.3)" className="w-full max-w-md flex flex-col h-full">
          ...
          <div className="flex justify-start">
            <a 
              href="#contact" 
              className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-purple-900/50 hover:bg-purple-800/60 text-purple-400 rounded-full border border-purple-500/40 transition-colors duration-300 w-fit"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.799-2.034c-.784-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
